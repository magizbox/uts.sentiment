...
test_data = join(dirname(dirname(dirname(__file__))), "data", "vlsp2018", "corpus", "hotel", "test.xlsx")
test_gold_data = join(dirname(dirname(dirname(__file__))), "data", "vlsp2018", "corpus", "hotel", "test-gold-data.xlsx")
