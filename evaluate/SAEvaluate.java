...
public class SAEvaluate {
	...
	public void evaluate(String gold, String answer) {
...

		{
			...
			System.out.printf("\tPrecision = %.2f", p);
			System.out.printf("\tRecall = %.2f", r);
			System.out.printf("\tF1 score = %.2f", f1);
			System.out.println();
			System.out.println();
		}
	...
	public static void main(String[] args) {
		if (args.length == 2) {
			...
			ltc.evaluateFolder(args[0], args[1]);
		} else if (args.length == 3) {
			PrintStream fileStream;
			try {
				fileStream = new PrintStream(args[2]);
			...
			System.out.println(
					"Usage for window: java -cp . SAEvaluate [Path of Gold Folder] [Path of Answer Folder] [output to file 'optional']");
			System.out.println("Example: java -cp . SAEvaluate D:\\VLSP\\SA-Test D:\\VLSP\\SA_Evaluate\\minhpqn");
			System.out.println("!!! Note: Answer files name must contain 'hotel' or 'restaurant'");

			//SAEvaluate ltc = new SAEvaluate();
			//ltc.evaluateFolder("D:\\VLSP\\SA-Test", "D:\\VLSP\\SA_Evaluate\\minhpqn");
		}
